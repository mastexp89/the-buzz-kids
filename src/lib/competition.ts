...
export const CIRCUS = {
  ...
  closesText: "5pm on Friday 24th July",   // for display
  winnerText: "Friday 24th July at 6pm",   // shown to entrants
  website: "https://www.circusextreme.co.uk/",
  logo: "/circus-extreme-logo.png",
  locations: [
    { city: "Aberdeen", place: "Beach Links (AB24 5EN)", dates: "17th July – 3rd August 2026" },
    { city: "Glasgow", place: "Silverburn Shopping Centre (G53 6AG, green car park)", dates: "7th – 23rd August 2026" },
  ],
};
